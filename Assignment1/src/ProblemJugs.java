...
public class ProblemJugs extends Problem{
    ...
    Set<Object> getSuccessors(Object state) {
        ...
        jug1_remaining_capacity = 12 - ss1.jugArray[jug1];
        ...
        jug1_remaining_capacity = 12 - ss2.jugArray[jug1];
        ...
        jug2_remaining_capacity = 8 - ss3.jugArray[jug2];
        ...
        jug2_remaining_capacity = 8 - ss4.jugArray[jug2];
        ...
        jug3_remaining_capacity = 3 - ss5.jugArray[jug3];
        ...
        jug3_remaining_capacity = 3 - ss6.jugArray[jug3];
        ...
        ss10.jugArray[jug1] = 12;
        set.add(ss10);

        //Fill 2
        ss11 = new StateJugs(jug_state);
        ss11.jugArray[jug2] = 8;
        set.add(ss11);

        //Fill 3
        ss12 = new StateJugs(jug_state);
        ss12.jugArray[jug3] = 3;
        set.add(ss12);
    ...
    private void resolveCapacity( StateJugs state ) {
        if( state.jugArray[jug1] > 12 ) state.jugArray[jug1] = 12;
        if( state.jugArray[jug2] > 8 ) state.jugArray[jug2] = 8;
        if( state.jugArray[jug3] > 3 ) state.jugArray[jug3] = 3;
        if( state.jugArray[jug1] < 0 ) state.jugArray[jug1] = 0;
        if( state.jugArray[jug2] < 0 ) state.jugArray[jug2] = 0;
        if( state.jugArray[jug3] < 0 ) state.jugArray[jug3] = 0;
    }
